  ...
  return (
    <div className="section">
      <div className="section-header">
        ...
        <select value={complexity} onChange={(e) => handleComplexityChange(e.target.value)} disabled={!checked}>
            ...
            return (
              <div key={addon.id} className="addon-row">
                ...
                <input
                  type="number"
                  value={addon.hours}
                  onChange={(e) => updateCustomAddon(addon.id, "hours", Number(e.target.value))}
                  disabled={!addon.checked || !addon.editing}
                />
                <input
                  type="number"
                  value={addon.rate}
                  onChange={(e) => updateCustomAddon(addon.id, "rate", Number(e.target.value))}
                  disabled={!addon.checked || !addon.editing}
                />
...
const Hardware = ({ onCostChange, onDataChange }) => {
  ...
  useEffect(() => {
    ...
    onDataChange(Object.values(sectionsData))
